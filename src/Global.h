...
class BaseTable {
    ...
    public:
        ...
        /* Get a value by its key, if not found return a reference to an object of the value class called with an empty constructor. */
        ...
        /* Set the entry in the table for the specified key to an object of the value class called with an empty constructor. */
...
struct MainOption {
       ...
       char shortName;          /* The short name for this option where a non-character option means none will be displayed, e.g. 'o' for '-o'. */
       std::string argument;    /* The argument this option, e.g. if longName is 'option', shortName is 'o', and argument is 'ARG', then we have '-o=ARG' and '--option=ARG'. */
       std::string byDefault;   /* The default value for this option, used if no this option is not specified as a command line argument. */
       bool takesMany;          /* Whether this option takes many arguments, false for 'it takes only one' true for 'it takes one or more'. */
       std::string description; /* The description of what this option does, used in the help text produced from the options. */
};
...
class MainConfig : public BaseTable<std::string, std::string> {
    ...
    public:
        ...
        /* The argument processing method, this takes the arguments provided to main, a header, a footer, and a list of options.
...
/* The global class. Currently used to provide a singleton instance of the global config. This class may be used to isolate all globals. */
class Global {
    private:
