...
TEST(Scheduler, SimpleProblem_101) {
    ...
    EXPECT_EQ(toVector(b, a), p.solve()) << "Problem: " << p << "\n";
}
...
TEST(Scheduler, SimpleProblem_102) {
    ...
    EXPECT_EQ(toVector(c, b, a), p.solve()) << "Problem: " << p << "\n";
}
...
TEST(Optimizer, RealWorldExample_1) {
    ...
    EXPECT_EQ(toVector(a, b, c), p.solve()) << "Problem: " << p << "\n";
}
...
TEST(Optimizer, RealWorldExample_2) {
    ...
    EXPECT_EQ(toVector(b, c, a, d), p.solve()) << "Problem: " << p << "\n";
}
