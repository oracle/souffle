...
#include <wavelib/util/file_position.hpp>
#include <wavelib/cpplexer/validate_universal_char.hpp>
#include <wavelib/cpplexer/cpplexer_exceptions.hpp>
#include <wavelib/cpplexer/token_cache.hpp>
#include <wavelib/cpplexer/convert_trigraphs.hpp>

#include <wavelib/cpplexer/cpp_lex_interface.hpp>
#include <wavelib/cpplexer/re2clex/scanner.hpp>
#include <wavelib/cpplexer/re2clex/cpp_re.hpp>
#if BOOST_WAVE_SUPPORT_PRAGMA_ONCE != 0
#include <wavelib/cpplexer/detect_include_guards.hpp>
#endif

#include <wavelib/cpplexer/cpp_lex_interface_generator.hpp>
