 ...
 * this software, associated documentation and/or data (collectively the "Software"), free of charge and under
 * any and all copyright rights in the  Software, and any and all patent rights owned or freely licensable by
 * each licensor hereunder covering either (i) the unmodified  Software as contributed to or provided by such
 ...
 * have sold the Software and the  Larger Work(s), and to sublicense the foregoing rights on either these or
 * other terms.
 *
 * This license is subject to the following condition: The above copyright notice and either this complete
 * permission notice or at a minimum a reference to the UPL must be included in  all copies or substantial
...
inline void writeRelationsToSqlite(std::string dbFilename, souffle::SouffleProgram* prog, bool onlyOutput) {
    ...
    std::vector<souffle::Relation*> relations =
            onlyOutput ? prog->getOutputRelations() : prog->getAllRelations();
