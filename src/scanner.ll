...
<INITIAL>{
[0-9]+"."[0-9]+"."[0-9]+"."[0-9]+  { // TODO: BEGIN(FINAL);
                                    try {
...
[\?a-zA-Z]|[_\?a-zA-Z0-9][_\?a-zA-Z0-9]+       { // TODO: BEGIN(FINAL);
                                    if (!strcmp(yytext, "_")) {
                                   } else {
